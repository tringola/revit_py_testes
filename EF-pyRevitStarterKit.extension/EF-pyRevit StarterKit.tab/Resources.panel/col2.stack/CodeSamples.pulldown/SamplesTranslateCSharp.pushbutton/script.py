# -*- coding: utf-8 -*-
__title__   = "Code Samples: Translate C-Sharp"
__doc__     = """Version = 1.0
Date    = 15.06.2024
________________________________________________________________
Description:

Click this button to open python file with 
Examples of C-Sharp Code Translations

Relative Path:
...\pyRevitStarterKit.extension\lib\Samples\TranslateCSharp.py
________________________________________________________________
How-To:
...
open_sample_file('TranslateCSharp.py')
