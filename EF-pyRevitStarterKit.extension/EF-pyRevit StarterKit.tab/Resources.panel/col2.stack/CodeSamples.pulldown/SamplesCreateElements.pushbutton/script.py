# -*- coding: utf-8 -*-
__title__   = "Code Samples: CreateElements"
__doc__     = """Version = 1.0
Date    = 15.06.2024
________________________________________________________________
Description:

Click this button to open python file with Examples 
for creating Elements with Revit API

Relative Path:
...\pyRevitStarterKit.extension\lib\Samples\CreateElements.py
________________________________________________________________
How-To:
...
open_sample_file('CreateElements.py')
