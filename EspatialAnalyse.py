"""
Est-ce que avec postgres seulement, je suis capable de sortir les relations analitiques de differents polygones ?
Exemple de base pour Shapely:
from shapely.geometry import Point, LineString, Polygon

# Exemples basiques
point = Point(0, 0)
ligne = LineString([(0, 0), (1, 1)])
polygone = Polygon([(0, 0), (1, 0), (1, 1), (0, 1)])

# Opérations courantes
intersection = polygone.intersection(ligne)  # Intersection
distance = point.distance(ligne)            # Distance
aire = polygone.area      
